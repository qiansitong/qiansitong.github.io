...
var Test_ak = 'B2a820ece2a4bb4337d0b3c6ec183cda';
var ServiceId = '115826';
...
define('track/demo', ['track/urls', 'track/message', 'track/track', 'track/draw', 'track/util', 'track/Timeline'], function (urls, message, trackModule, drawModule, Util, timeLineControl) {
    ...
    return {
        ...
        getTraceDetail: function () {
            ...
            urls.jsonp('http://api.map.baidu.com/trace/v2/entity/add', params, sucCbk);
        ...
        loadData: function (pageIndex, before, after) {
            ...
            urls.jsonp('http://api.map.baidu.com/trace/v2/entity/add', params, function (res) {
                if (res.status === 0) {
